...
{
  "nodeExecutable": "../../node/win/banyan-node.exe",
  "webPort": 8080
}
EOF
...
{
  "nodeExecutable": "../../node/linux/banyan-node",
  "webPort": 8080
}
EOF
...
cat > "$OUTPUT_DIR/osx/banyan-cli.json" << EOF
{
  "nodeExecutable": "../../node/osx/banyan-node-amd64",
  "webPort": 8080
}
EOF
...
{
  "nodeExecutable": "../../node/osx/banyan-node-arm64",
  "webPort": 8080
}
EOF
